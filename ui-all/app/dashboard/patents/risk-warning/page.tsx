...
const institutionsByLetter = {
  A: ["安徽大学", "安徽工业大学", "安徽理工大学"],
  B: ["北京大学", "北京理工大学", "北京航空航天大学", "北京师范大学", "北京邮电大学"],
  C: ["重庆大学", "重庆邮电大学", "重庆交通大学"],
  // 其他字母组略...
}
...
const initialMessages: Message[] = [
  {
    id: "1",
    content: "您好，我是AI专利助手。请描述您的专利技术方案，我将帮助您评估潜在的侵权风险。",
    sender: "assistant",
    timestamp: new Date(),
  },
]
...
export default function RiskWarningPage() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    // 跳转到结果页面
    router.push(`/dashboard/patents/risk-warning/results?${searchParams.toString()}`)
  }
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      const assistantMessage: Message = {
        ...
        content:
          "感谢您的描述！我已经分析了您的专利技术方案。这看起来是一个关于芯片缺陷检测的创新方法。我已将您的描述添加到侵权风险评估中，您可以在右侧搜索框中添加更多筛选条件，或直接点击搜索按钮查看潜在的侵权风险。",
        sender: "assistant",
        timestamp: new Date(),
      }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header title="芯智领航者 - 侵权风险预警" backUrl="/dashboard/patents" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="h-[600px] flex flex-col">
            <CardHeader>
              ...
              <CardDescription>描述您的专利详情，AI助手将帮助您评估潜在的侵权风险</CardDescription>
            </CardHeader>
                    ...
                    >
                      {message.sender === "assistant" && (
                        <Avatar className="h-8 w-8">
                          ...
                          <AvatarFallback className="bg-red-100 text-red-600">AI</AvatarFallback>
                        </Avatar>
                      )}
                      <div>
                ...
                {isAnalyzing && (
                  <div className="flex justify-start">
                    <div className="max-w-[80%] rounded-lg p-3 bg-gray-100 text-gray-800 flex items-start gap-2">
                      ...
                      <div>
                        <p className="text-sm">正在分析潜在侵权风险...</p>
                        <div className="mt-2 flex gap-1">
                          <span className="animate-bounce delay-0 h-2 w-2 bg-red-600 rounded-full"></span>
                          <span className="animate-bounce delay-150 h-2 w-2 bg-red-600 rounded-full"></span>
                          <span className="animate-bounce delay-300 h-2 w-2 bg-red-600 rounded-full"></span>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>输入关键词或使用筛选条件进行侵权风险评估</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSearch}>
                  ...
                  <Card className="mb-4 bg-red-50">
                    <CardContent className="pt-4">
                      <div className="flex items-start gap-2">
                        <Lightbulb className="h-5 w-5 text-red-600 mt-0.5" />
                        <div>
                          <h3 className="text-sm font-medium">您描述的专利技术</h3>
                ...
                <div className="text-sm text-gray-500 mt-2 text-center">
                  注：技术领域、归属单位、发明人为可选的补充搜索条件，可提高风险评估准确度
                </div>
